...
AGENT_RUNTIME_POST_HOOK_TOOL_NAMES = frozenset(
    {"todo", "session_search", "memory", "clarify", "read_terminal", "read_preview", "read_window_below", "delegate_task", "a2a_delegate"}
)
...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    if function_name == "todo":
        ...
        def _execute(next_args: dict) -> Any:
            return _finish_agent_tool(agent._dispatch_a2a_delegate(next_args), next_args)
    else:
        def _execute(next_args: dict) -> Any:
    ...
    def _execute_with_user_env(next_args: dict) -> Any:
        try:
    ...
    return run_tool_execution_middleware(
        function_name,
        function_args,
        lambda next_args: _execute_with_user_env(next_args if isinstance(next_args, dict) else function_args),

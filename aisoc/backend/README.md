...
```bash
python aisoc/backend/main.py --module server --port 9120 --tui
python aisoc/backend/main.py --module a2a --host 127.0.0.1 --port 9086
python aisoc/backend/main.py --module extcli
```
...
```bash
python aisoc/backend/main.py --module server --host 127.0.0.1 --port 9120 --no-open --tui
```

...
def cmd_aisoc(args):
    """Delegate AISOC startup and module dispatch to the backend entrypoint."""
...
""",
    ...
    from aisoc.backend.main import configure_aisoc_parser as _configure_aisoc_parser

    _configure_aisoc_parser(aisoc_parser)

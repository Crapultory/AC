...
const RESTART_CONFIRMATION_PHRASE = "RESTART WORKAGENT";
...
export function SettingsPage({
  ...
  async function requestRestart(): Promise<void> {
    ...
    try {
      ...
      setRestartError("Restart request failed. WORKAGENT is still running.");
  ...
  return (
    <section className="settings-workbench-page">
      <PageMissionHeader
        title="Settings"
        subtitle="Inspect this WORKAGENT runtime and perform guarded service operations."
        status={
      ...
      <article className="detail-panel settings-runtime-panel" aria-labelledby="runtime-status-title">
        <div className="settings-panel-heading">
          ...
          <span className="settings-panel-code">WORKAGENT // LOCAL</span>
        </div>
      ...
      <article className="detail-panel settings-danger-panel" aria-labelledby="dangerous-actions-title">
        ...
        <div className="settings-danger-copy">
          ...
          {restarting ? (
            <p className="settings-restart-state" role="status">
              Restarting WORKAGENT. Waiting for the public health check to recover…
            </p>
          ) : null}
        </div>
        <button
        ...
        >
          {restarting ? "Restarting…" : "Restart WORKAGENT"}
        </button>
      </article>
            ...
            {confirmationStage === "danger" ? (
              <>
                <p id="restart-dialog-description" className="subtle-copy">
                  WORKAGENT will stop accepting requests while the process restarts. Active work may be interrupted.
                </p>

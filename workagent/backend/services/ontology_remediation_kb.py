"""Per-subcapability remediation knowledge base for WORKAGENT Ontology v3 (3-layer).
...
REMEDIATION_KB: dict[str, dict[str, str]] = {
    ...
    "D0.4": {"gap": "知识库/RAG 存在雏形，但会话历史与检索引用尚未标准化为可扫描对象。",
             ...
             "assets": "workagentwiki、session history、检索索引", "impact": "缺失时 AI 回答难以引用证据，防幻觉能力打折。", "effort": "M"},
    ...
    "D9.4": {"gap": "知识库运营检索动作缺少标准化对象证据。",
             ...
             "assets": "workagentwiki、检索索引", "impact": "知识沉淀不规范会降低复用效率。", "effort": "S"},
}

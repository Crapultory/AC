  ...
  return (
    <aside id="sidebar-container" className="w-64 bg-[#05080F] border-r border-slate-800 flex flex-col h-screen overflow-y-auto shrink-0 scrollbar-thin">
      ...
      <div className="px-1.5 py-4 flex-1">
        ...
        <div className="text-[10px] font-mono tracking-widest text-slate-500 px-4 mb-2 uppercase font-bold">CONTROL</div>
      ...
      <div className="p-6 border-t border-slate-800/50 bg-[#03060C] shrink-0">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="overflow-hidden">
            ...
            <div className="text-[9px] text-slate-500 font-mono truncate mt-1">v2.5.0-IDENTITY</div>
          </div>
        </div>
      </div>
    </aside>
